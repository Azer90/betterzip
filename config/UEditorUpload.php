...
return [
    ...
    */
    ...
    'upload' => [
        ...
        "imagePathFormat" => "/upload/ueditor/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "scrawlPathFormat" => "/upload/ueditor/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "snapscreenPathFormat" => "/upload/ueditor/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "catcherPathFormat" => "/upload/ueditor/images/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "imageManagerListPath" => "/upload/ueditor/images/", /* 指定要列出图片的目录 */
